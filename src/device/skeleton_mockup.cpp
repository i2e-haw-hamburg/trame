...
skeleton skeleton_mockup::get()
{
    ...
    // left arm
    joint left_hand;
    left_hand.normal << 100, 0, 0;
    left_hand.point << 0, -50, 0;
    ...
    // right arm
    joint right_hand;
    right_hand.normal << -100, 0, 0;
    right_hand.point << 0, -50, 0;
