...
namespace Trame.Implementation.Skeleton
{
    class Creator
    {
        ...
        private static ISkeleton CreateSkeleton()
        {
            int centerY = 1100;
            int upperBodyY = 350;
            ...
            IJoint neck = CreateParent(new List<IJoint> {head, rightShoulder, leftShoulder});
            neck.Point = new Vector3(0, upperBodyY, 0);
            neck.JointType = JointType.NECK;
            neck.Valid = true;

            IJoint center = CreateParent(new List<IJoint> {neck, rightHip, leftHip});
        ...
        private static IJoint CreateArm(Side side)
        {
            int handLength = 50;
            int forearmX = 50;
            int forearmY = 355;
        ...
        private static IJoint CreateLeg(Side side)
        {
            int footLength = 255;
            int lowerLegY = 410;
            int thighY = 540;
            ...
            var footNormal = new Vector3(0, 0, -1000);
